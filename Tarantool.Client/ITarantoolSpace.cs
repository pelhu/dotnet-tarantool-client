...
namespace Tarantool.Client
{
    ...
    public interface ITarantoolSpace<T>
    {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The <see cref="Task" /></returns>
        Task InsertMultipleAsync(List<T> entities, CancellationToken cancellationToken = default(CancellationToken), bool inTransaction = true);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The <see cref="Task" /></returns>
        Task ReplaceMultipleAsync(List<T> entities, CancellationToken cancellationToken = default(CancellationToken), bool inTransaction = true);
