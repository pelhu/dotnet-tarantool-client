namespace Tarantool.Client.Models
{
    ...
    public class IndexKey<TK1, TK2, TK3, TK4, TK5, TK6> : IndexKey
    {
        /// <summary>Initializes a new instance of the <see cref="IndexKey{TK1,TK2,TK3,TK4,TK5,TK6}" /> class.</summary>
        ...
        public IndexKey(TK1 keyPart1Value, TK2 keyPart2Value, TK3 keyPart3Value, TK4 keyPart4Value, TK5 keyPart5Value, TK6 keyPart6Value)
        {
            Key = new object[] { keyPart1Value, keyPart2Value, keyPart3Value, keyPart4Value, keyPart5Value, keyPart6Value };
        }
    }
}